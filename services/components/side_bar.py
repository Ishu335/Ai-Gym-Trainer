        ...
        with st.sidebar:
            ...
            if workout_started is False:
                ...
                exercise = st.selectbox(
                    "Exercise",
                    ["Squats", "Bicep Curls", "Push Ups", "Lunges","Shoulder Press"],
                    index=0
                )
                ...
                # Workout Progress
                # =========================
                if st.session_state.workout_started is True:
                    st.subheader("📊 Workout Progress")

                    sets=st.session_state.plan_sets
                    reps=st.session_state.plan_reps
            ...
            if  st.session_state.get("workout_started", True):
